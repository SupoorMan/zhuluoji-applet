	...
	<view class="trans-page">
		...
		<view class="trans-content">
			<van-cell-group inset>
				<van-cell required label="来源" :value="sourceText" placeholder="订单来源" border="false" is-link
					@tap="showSource = true" />
				<van-field required label="订单编号" :value="add.orderNo" placeholder="请输入订单编号" border="false"
		...
		<view class="btn-box">
			<van-button @click="addOrder" round block color="#cea6fe">确认兑换</van-button>
		</view>
		<!-- 来源 -->
