<template>
	<view class="info-page">
		...
		<van-cell is-link title="地区" :value="fieldValue || '请选择地区'" @click="showSelectAddress = true" />
		...
		<van-cell is-link title="小红书账号" value="请输入小红书账号" link-type="navigateTo" url="/pages/user/redbook/redbook" />
		<!-- 性别 -->
