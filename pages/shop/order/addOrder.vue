    ...
    <view class="contract-cell">
      <van-cell-group :border="false">
        <van-cell
          ...
          title="规格"
          title-width="100rpx"
          :value="currentSpecs ? currentSpecs.text : '-'"
      ...
      >
        <van-radio-group :value="selectAddress">
          <view style="line-height: 80rpx; padding-left: 24rpx"
            >选择配送地址</view
          >
          <van-cell-group>
            <van-cell
      ...
      >
        <van-picker
          ...
          @confirm="selectSpecs"
          @cancel="showSpecs = false"
        />
      </van-popup>
      <van-dialog id="van-dialog" />
    </view>
    <view class="btn-box">
      <van-button @click="addOrder" round block color="#F9CD90"
        >确认兑换</van-button
      >
    </view>
  </view>
...
import { addOrder2 } from "@/api/order";
